...
# diagonal showws distribution of variables
# lower left is a scatter plot helping explore the correlation with data
# upper right shoes the correlation coefficients
...
**shoot mass is strongly positively correlated with total mass with a correlation coefficient of 0.902**

**SLA and leaf dry weight are weakly correlated with a correlation coefficient of 0.033**

**root mass and total mass are strongly correlated with a correlatio coefficient of 0.858**
...
**Some species have a higher total mass while some have lower. Grindelila seems to have the highest biomass, while the one called glaber has the lowest. **
...
**It looks like well watered plants have more total mass. Total biomass is greater when plants are well watered.**
...
**There seems to be a slight positive correlation but its quite weak. Moderate-strong correlation depending on how you round.**
